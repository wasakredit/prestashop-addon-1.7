...
class Wasa_Kredit_Checkout_SdkHelper
{
    public static function CreateClient() {
        ...
        return Sdk\ClientFactory::CreateClient(
            $config['WASAKREDIT_TEST'] ? $config['WASAKREDIT_TEST_CLIENTID'] : $config['WASAKREDIT_CLIENTID'],
            $config['WASAKREDIT_TEST'] ? $config['WASAKREDIT_TEST_CLIENTSECRET'] : $config['WASAKREDIT_CLIENTSECRET'],
